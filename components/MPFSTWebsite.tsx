          ...
          <Card className="bg-gray-900">
            <CardContent className="p-6 space-y-4">
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div className="overflow-x-auto">
                  <div className="w-full overflow-x-auto -mx-2 sm:mx-0 bg-gray-900"><table className="min-w-[640px] table-auto w-full border-collapse border border-gray-600 text-xs sm:text-sm whitespace-normal break-words">
                    <thead>
                      <tr>
                        <th className="border px-2 py-1">#</th>
